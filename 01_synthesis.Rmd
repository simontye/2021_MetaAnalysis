...
wos <- ma.eval(wos, 415,  "prob not", "intra, field exp")
...
wos <- ma.eval(wos, 455,  "prob not", "complex comm, model")
...
wos <- ma.eval(wos, 512,  "prob not", "pred vocal, obs")
...
wos <- ma.eval(wos, 545,  "prob not", "complex comm, colon")
wos <- ma.eval(wos, 546,  "prob not", "complex comm, mut")
...
wos <- ma.eval(wos, 556,  "prob not", "complex comm")
